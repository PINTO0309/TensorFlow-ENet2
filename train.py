...
with tf.Session() as sess:
    ...
    for epoch in range(no_of_epochs):
        ...
        for step, (imgs, onehot_labels) in enumerate(train_data_iterator()):
            ...
            batch_loss, _ = sess.run([model.loss, model.train_op], feed_dict=batch_feed_dict)
        ...
        pickle.dump(train_loss_per_epoch, open("%strain_loss_per_epoch.pkl" % model.model_dir, "wb"))
        ...
        pickle.dump(val_loss_per_epoch, open("%sval_loss_per_epoch.pkl" % model.model_dir, "wb"))
